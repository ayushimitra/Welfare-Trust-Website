    ...
    <div className="bg-gray-900 text-white py-8 w-full">
      <div className=" px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        ...
        <div className="text-center md:text-left">
          <img src= '' alt="logo" className="w-24 h-auto mx-auto md:mx-0"/>
          ...
          <div className="flex justify-center md:justify-start mt-4 gap-4">
            <img src='' alt="facebook" className="w-8 h-8 cursor-pointer rounded-full"/>
            <img src=''alt="twitter" className="w-8 h-8 cursor-pointer  rounded-full"/>
            <img src='' alt="linkedin" className="w-8 h-8 cursor-pointer rounded-full"/>
          </div>
        </div>
